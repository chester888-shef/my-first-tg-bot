...
def target_menu():
    ...
    btn_target_goal = types.InlineKeyboardButton(text = 'Сума цілі: ', callback_data = 'target_goal')
    btn_remaintogoal = types.InlineKeyboardButton(text = 'Залишок до цілі: ', callback_data = 'target_remaintogoal')

    markup.add(btn_target_goal, btn_remaintogoal)
